<ul class="social">
	...
	<li class="twitter">
		<a href="https://twitter.com/home?status=<?php the_title(); echo '%0a'; bloginfo('name'); echo '%0a'; echo get_the_permalink(); //gera_url_encurtada(get_the_permalink()); ?>" title="Twitter" target="_blank"><i class="fa fa-twitter"></i></a>
	</li>
